...
public class VadeliHesap extends BankaHesap implements Kredi {

    public VadeliHesap(String hesapNo, String hesapSahibi, double bakiye, LocalDate açılışTarihi) {
    ...
    public void paraCek(double miktar) {
        ...
        System.out.println("Hesap türü: " + getClass().getSimpleName() + " -> " + "Para çekildi!" + " -> "
                + " Yeni bakiye: " + getBakiye() + " Çekilen miktarın faiz oranı: "
                + faizHesapla(miktar));
    }
